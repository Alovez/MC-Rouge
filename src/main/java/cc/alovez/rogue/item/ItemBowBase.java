...
public abstract class ItemBowBase extends ItemBow implements ModelRegisterCallback {
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
                if (entityIn == null) {
                    ...
                    return !itemstack.isEmpty() && itemstack.getItem() instanceof ItemBowBase ? (float) (stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F : 0.0F;
                }
            }
        });
    }
