 ...
 *
 */
public class EntityTimingArrow extends AbstractArrow {
    public static float tpRange = 32.0F;

    public EntityTimingArrow(World par1World) {
        super(par1World);
    }

    public EntityTimingArrow(World par1World, EntityLivingBase par2EntityLivingBase) {
        super(par1World, par2EntityLivingBase);
    }

    public EntityTimingArrow(World par1World, double x, double y, double z) {
